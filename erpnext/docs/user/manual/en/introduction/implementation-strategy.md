...
Once you are familiar with ERPNext, start entering your live data!
  ...
  * You can also setup a new account at [https://erpnext.com](https://innexa.co), and use the 30-day free trial. [Find out more ways of deploying ERPNext](/introduction/getting-started-with-erpnext)
  ...
  * If you need help, [you can buy support](https://innexa.co) or [ask in the user forum](https://innexa.co).
