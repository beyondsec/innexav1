frappe.pages['welcome-to-erpnext'].on_page_load = function(wrapper) {
	...
	parent.find(".video-placeholder").on("click", function() {
		...
		parent.find(".embed-responsive").append('<iframe class="embed-responsive-item video-playlist" src="https://www.youtube.com/embed/_fjFnEjvGt8" allowfullscreen></iframe>')
	});
